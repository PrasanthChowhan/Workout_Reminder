...
class CustomToastNotification:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if "overrideredirect" not in self.kwargs:
            self.kwargs["overrideredirect"] = False
    ...
    def show_toast(self, *_):
        ...
        # build toast
        self.toplevel = ttkb.Toplevel(**self.kwargs)
        self._setup(self.toplevel)

        self.container = ttkb.Frame(self.toplevel, bootstyle=self.bootstyle)
    ...
    def _setup(self, window: ttkb.Toplevel):
...
if __name__ == "__main__":
    ...
    CustomToastNotification(
        ...
        "This is a toast message; you can place a symbol on the top-left that is supported by the selected font. You can either make it appear for a specified period of time, or click to close.", alert=True, minsize=(500, 100), position=(100, 100, 'se')
    ).show_toast()
